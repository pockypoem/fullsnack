...
interface IController {
    ...
    create(req: Request, res:Response) : Response | Promise<Response>; //TODO: untuk membuat data
    ...
    delete(req: Request, res:Response) : Response | Promise<Response>; //TODO: untuk hapus data
}
